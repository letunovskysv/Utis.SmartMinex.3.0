...
// Описание: RuntimeSchedule – Менеджер расписаний.
//--------------------------------------------------------------------------------------------------
namespace Utis.SmartMinex.Runtime;

/// <summary> Менеджер расписаний.</summary>
/// <typeparam name="T"></typeparam>
public class RuntimeSchedule<T>
{
    #region Declarations

    readonly Thread _thread = new((o) => ((RuntimeSchedule<T>)o).ScheduleThreadFunc()) { IsBackground = true };
    ...
    public int? Add(T data, ScheduleOptions pars)
    {
    ...
    public bool Modify(int id, T data, ScheduleOptions pars) =>
    ...
    static long? GetFirstKey(ScheduleOptions pars, DateTime? since = null)
    {
    ...
    static long? GetNextKey(ScheduleOptions pars, long prev, long bound) =>
    ...
    struct XScheduleItem
    {
        ...
        public ScheduleOptions Params { get; init; }
    }
