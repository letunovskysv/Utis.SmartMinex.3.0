...
public class GMeshFactory
{
    ...
    static int _tessellation;
    static double[] _sin; // Кэшируем операции синуса
    static double[] _cos; // Кэшируем операции косинуса
    ...
    internal static int Lod
    {
        ...
        {
            _tessellation = value;
            _sin = new double[_tessellation];
            _cos = new double[_tessellation];
            var ang = Math.PI * 2 / _tessellation;
